...
class WarehouseItemFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    private function getWarehouseItems(): array
    {
        return [
            [
                'product' => null,
                'identifier' => WarehouseStructureTreeFixtures::NODE_CONTAINING_CHILDREN_NAME . '001',
            ...
            [
                'product' => null,
                'identifier' => WarehouseStructureTreeFixtures::NODE_CONTAINING_CHILDREN_NAME . '002',
            ...
            [
                ...
                'identifier' => WarehouseStructureTreeFixtures::NODE_CONTAINING_CHILDREN_NAME . '003',
            ...
            [
                'product' => null,
                'identifier' => WarehouseStructureTreeFixtures::NODE_CONTAINING_CHILDREN_NAME . '004',
